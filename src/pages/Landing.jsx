    ...
    return (
        <>
            <div className="relative min-h-screen flex flex-col">
                ...
                <header className="absolute inset-x-0 top-0 z-50 p-4 md:p-8">
                    <nav className="max-w-[1440px] mx-auto bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-8 py-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <span className="material-symbols-outlined text-white text-3xl">ecg_heart</span>
                            <span className="text-white text-xl font-normal tracking-wide">Saha Medical</span>
                        </div>
                        <div className="hidden lg:flex items-center justify-center gap-12 flex-1">
                            <a className="text-white/80 hover:text-white text-sm tracking-widest font-medium uppercase transition-colors" href="#specialties">Specialties</a>
                            <a className="text-white/80 hover:text-white text-sm tracking-widest font-medium uppercase transition-colors" href="#concierge">Concierge</a>
                            <a className="text-white/80 hover:text-white text-sm tracking-widest font-medium uppercase transition-colors" href="#experts">Experts</a>
                        </div>
                        <div className="hidden lg:flex">
                            <a className="bg-white text-primary px-8 py-3 rounded-2xl text-sm font-medium tracking-wide transition-all hover:-translate-y-0.5" href="#booking">
                                Book Now
                            </a>
                        </div>
                ...
                <header className="relative flex-grow flex items-center z-10">
                    <div className="max-w-[1440px] mx-auto px-8 lg:px-16 w-full pb-20">
                        <div className="max-w-4xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                                <a className="bg-white text-primary px-10 py-4 rounded-2xl text-base font-medium tracking-wide transition-all hover:bg-slate-100 flex items-center" href="#booking">
                                    Book your visit
                                </a>
                                <a className="bg-transparent border border-white text-white px-10 py-4 rounded-2xl text-base font-medium tracking-wide transition-all hover:bg-white/10 flex items-center" href="#">
                                    Discover more
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="absolute bottom-10 right-8 lg:bottom-16 lg:right-16 flex flex-col items-end gap-12 z-[100] text-white">
                        ...
                        <div className="flex flex-col gap-4">
                            <a href="#" aria-label="X (Twitter)" className="w-10 h-10 rounded-2xl border border-white/30 flex items-center justify-center text-white/80 hover:bg-white hover:text-primary hover:border-white transition-all backdrop-blur-sm">
                            ...
                            <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-2xl border border-white/30 flex items-center justify-center text-white/80 hover:bg-white hover:text-primary hover:border-white transition-all backdrop-blur-sm">
                            ...
                            <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-2xl border border-white/30 flex items-center justify-center text-white/80 hover:bg-white hover:text-primary hover:border-white transition-all backdrop-blur-sm">
            ...
            <section className="py-24 lg:py-32 bg-[#F8F9FA]">
                <div className="max-w-[1440px] mx-auto pl-8 lg:pl-16 pr-0">
                    <div className="flex flex-col lg:flex-row gap-20 items-center">
                        <div className="w-full lg:w-1/2 pr-8 lg:pr-0">
                            <div className="max-w-xl">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                                    <div className="group">
                                        <div className="w-12 h-12 bg-[#1A2530] flex items-center justify-center mb-6 rounded-2xl">
                        ...
                        <div className="w-full lg:w-1/2 flex justify-end">
                            <div className="w-full lg:max-w-md aspect-[3/4] bg-slate-100 overflow-hidden rounded-none">
                ...
                <div className="max-w-[1440px] mx-auto px-8 lg:px-16">
                    <div className="flex justify-between items-end mb-16">
                        ...
                        <div className="flex gap-4">
                            <button onClick={() => scrollExperts('left')} className="w-14 h-14 rounded-2xl border border-hero-blue text-hero-blue flex items-center justify-center hover:bg-hero-blue hover:text-white transition-all">
                                <span className="material-symbols-outlined">chevron_left</span>
                            </button>
                            <button onClick={() => scrollExperts('right')} className="w-14 h-14 rounded-2xl border border-hero-blue text-hero-blue flex items-center justify-center hover:bg-hero-blue hover:text-white transition-all">
                    ...
                    <div ref={expertsCarouselRef} className="flex overflow-x-auto gap-8 pb-12 no-scrollbar scroll-smooth snap-x snap-mandatory -mx-8 px-8 lg:-mx-16 lg:px-16">
                        <div className="flex-none w-[340px] md:w-[420px] h-[550px] relative group rounded-none overflow-hidden snap-start">
                            {/* Base full image */}
                            ...
                            <div className="absolute inset-0 bg-card-grey p-10 flex flex-col items-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10">
                                <div className="w-40 h-40 rounded-none overflow-hidden mb-8 transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                                ...
                                <div className="flex flex-wrap justify-center gap-3 mt-auto transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-200">
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">March 28</span>
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">Cardiology</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-none w-[340px] md:w-[420px] h-[550px] relative group rounded-none overflow-hidden snap-start">
                            ...
                            <div className="absolute inset-0 bg-card-grey p-10 flex flex-col items-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10">
                                ...
                                <div className="flex flex-wrap justify-center gap-3 mt-auto transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-200">
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">April 02</span>
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">Neurology</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-none w-[340px] md:w-[420px] h-[550px] relative group rounded-none overflow-hidden snap-start">
                            ...
                            <div className="absolute inset-0 bg-card-grey p-10 flex flex-col items-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10">
                                ...
                                <div className="flex flex-wrap justify-center gap-3 mt-auto transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-200">
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">March 25</span>
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">Integrative</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-none w-[340px] md:w-[420px] h-[550px] relative group rounded-none overflow-hidden snap-start">
                            ...
                            <div className="absolute inset-0 bg-card-grey p-10 flex flex-col items-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10">
                                ...
                                <div className="flex flex-wrap justify-center gap-3 mt-auto transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500 delay-200">
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">April 10</span>
                                    <span className="bg-pill-blue text-text-pill-blue px-6 py-2.5 rounded-2xl text-xs font-semibold uppercase tracking-wider">Genomics</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex overflow-hidden group -mx-8 px-8 lg:-mx-16 lg:px-16">
                        <div className="flex w-max animate-marquee hover:[animation-play-state:paused] gap-8 pb-12">
                            ...
                            {[...testimonialsData, ...testimonialsData].map((testimonial, idx) => (
                                <div key={idx} className="flex-none w-[380px] md:w-[450px] bg-card-grey rounded-none p-12 flex flex-col justify-between min-h-[500px] hover:-translate-y-2 transition-transform duration-300">
                                    <p className="text-3xl md:text-4xl font-normal text-primary leading-tight tracking-tight">
                                        "{testimonial.quote}"
                                    </p>
                                    <div className="flex items-center gap-5 mt-10">
                                        <img alt={testimonial.name} className="w-14 h-14 rounded-none object-cover" src={testimonial.image} />
                                        <div>
                ...
                <div className="sticky top-0 h-screen overflow-hidden w-full flex flex-col justify-center items-center z-20 pointer-events-none">
                    <div className="relative w-full max-w-xl text-center px-4">
                        ...
                        <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex flex-col items-center pointer-events-auto w-full">
                            ...
                            <a href="#book" className="flex items-center bg-[#0F172A] text-white px-10 py-4 hover:bg-black transition-colors rounded-2xl group text-base font-medium tracking-wide shadow-lg hover:shadow-xl">
